...
// Creación de la base de datos
const ver_colecciones = 'show collections';   
...
db.participante.find({}, { _id: 1 });

// Obtener los ObjectId de todos los registros del rol participante
db.participante.find({ rol: { $eq: "Participante" } }, { _id: 1 });
...
db.participante.deleteMany({ rol: "Entrenador" });

// Eliminar Registros por nombre de parametro
db.participante.deleteMany({ rol: "Árbitro" });


// Cambiar el nombre a una colección
db.participante.renameCollection("participante");
